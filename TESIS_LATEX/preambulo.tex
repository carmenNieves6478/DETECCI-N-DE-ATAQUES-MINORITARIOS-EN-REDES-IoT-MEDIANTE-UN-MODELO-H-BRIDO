...
% Estilo de Leyendas (Captions) alineado a Guía UNAP / APA 7:
% "Tabla 1" o "Figura 1" en Negrita al INICIO, Salto de línea, y Título descriptivo en Cursiva
...
% -------------------------------------------------------------------------
% Configuración de Títulos y Capítulos (Guía UNAP 2.0 / APA 7)
% -------------------------------------------------------------------------

\usepackage{titlesec}

% CAPÍTULO I (16pt, Negrita, Centrado)
% INTRODUCCIÓN (14pt, Negrita, Centrado, MAYÚSCULA)
\titleformat{\chapter}[display]
    {\bfseries\centering}
    {\fontsize{16pt}{18pt}\selectfont\MakeUppercase{CAPÍTULO \Roman{chapter}}}
    {6pt}
...
% Formato de numeración con punto al final (2.1., 2.2.1., 2.2.1.1.)
\renewcommand{\thesection}{\thechapter.\arabic{section}.}
\renewcommand{\thesubsection}{\thechapter.\arabic{section}.\arabic{subsection}.}
\renewcommand{\thesubsubsection}{\thechapter.\arabic{section}.\arabic{subsection}.\arabic{subsubsection}.}

% NIVEL 2 (Ej. 2.1. TÍTULO SECCIÓN) - 14pt, MAYÚSCULA, Negrita, Izquierda
\titleformat{\section}
    {\bfseries\fontsize{14pt}{16pt}\selectfont\raggedright}
    {\thesection}
    {0.5em}
    {\MakeUppercase}

% NIVEL 3 (Ej. 2.2.1. Título Subsección) - 12pt, Minúscula, Negrita, Izquierda
...
% NIVEL 4 (Ej. 2.2.1.1. Título Sub-subsección) - 12pt, Minúscula, Negrita, Izquierda
