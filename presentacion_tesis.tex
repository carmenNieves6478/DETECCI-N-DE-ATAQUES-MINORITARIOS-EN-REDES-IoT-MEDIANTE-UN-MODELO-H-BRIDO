...
% -----------------------------------------------------------------------------
\title[Detección de Ataques Minoritarios IoT]{DETECCIÓN DE ATAQUES MINORITARIOS EN REDES IoT MEDIANTE UN MODELO HÍBRIDO STACKING CON ENTROPÍA DE SHANNON Y BORDERLINE-SMOTE}
\subtitle{Sustentación de Tesis para Optar el Título Profesional de Ingeniera de Sistemas}
\author[Carmen Nieves]{Bach. Carmen Nieves}
\institute[UNAP]{
